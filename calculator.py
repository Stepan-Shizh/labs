...
class Calculator(QWidget):
    def __init__(self):
        ...
        #виджеты с привязкой к соответствующим осям выравнивания:
    ...
    def _result(self):
        try:
            ...
            self.input.setText("Error. You have divided the number by zero. Try again!")
        except:
            self.input.setText("Error. Maybe you entered the numbers incorrectly. Try again!")
